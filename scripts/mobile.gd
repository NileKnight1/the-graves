...
#
#
#func _on_left_button_down() -> void: Input.action_press("left")
#func _on_left_button_up() -> void: Input.action_release("left")
#
...
#
#func _on_jump_button_down() -> void: Input.action_press("jump")
#func _on_jump_button_up() -> void: Input.action_release("jump")
